# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-10 05:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified_time', models.DateTimeField(auto_now=True, verbose_name='')),
                ('status', models.CharField(choices=[('d', 'Draft'), ('p', 'Published')], max_length=1, verbose_name='\u6587\u7ae0\u72b6\u6001')),
                ('abstract', models.CharField(blank=True, help_text='\u53ef\u9009\uff0c\u82e5\u4e3a\u7a7a\u5c06\u6458\u53d6\u6b63\u6587\u7684\u524d54\u4e2a\u5b57\u7b26', max_length=70, null=True, verbose_name='\u6458\u8981')),
